...
const ARCHIVE_PROJECTS: Project[] = [
  {
    ...
    side: 'right',
    isLive: false,
    cursorLabel: 'Real-Time Face Recognition Attendance System Build with Python ',
  },
  {
    ...
    side: 'left',
    isLive: false,
    cursorLabel: 'Real-Time Bus Tracking App With Multi-Bus Tracking Feature',
  },
  {
    ...
    cursorLabel: 'E-Commerce Website For Crochet Items ↗',
  },
  {
    ...
    cursorLabel: 'Visit The Photography Portfolio ↗',
  },
  {
    title: 'E-Book store',
    category: 'E-Commerce',
    ...
    cursorLabel: 'VISIT THE E-BOOK STORE FOR FREE E-BOOKS ↗',
  },
];
...
export function Projects() {
  ...
  return (
    ...
    >
      <CursorFollow defaultText="EXPLORE PROJECT ↗" className="relative">
        {/* Header */}
        ...
        {/* Timeline */}
        <div className="relative px-4 sm:px-8 md:px-12 lg:px-24 min-h-screen pb-16 md:pb-32">
          <div ref={timelineContainerRef} className="relative w-full h-full">
          ...
          <div className="flex flex-col gap-16 md:gap-24 relative">
            {ARCHIVE_PROJECTS.map((project, index) => {
              ...
              return (
                <div
                  key={index}
                  data-cursor-text={project.cursorLabel || (project.link ? 'EXPLORE ↗' : 'PROJECT ARCHIVE')}
